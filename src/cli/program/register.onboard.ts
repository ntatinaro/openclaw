...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option(
      "--auth-choice <choice>",
      "Auth: setup-token|token|chutes|openai-codex|openai-api-key|openrouter-api-key|ai-gateway-api-key|moonshot-api-key|kimi-code-api-key|synthetic-api-key|venice-api-key|gemini-api-key|zai-api-key|xiaomi-api-key|apiKey|minimax-api|minimax-api-lightning|opencode-zen|groq-api-key|watsonx-api-key|skip",
    )
    .option(
      "--token-provider <id>",
    ...
    .option("--watsonx-api-key <key>", "IBM Watsonx API key")
    .option("--watsonx-project-id <id>", "IBM Watsonx project ID")
        ...
        await onboardCommand(
          {
            ...
            watsonxApiKey: opts.watsonxApiKey as string | undefined,
            watsonxProjectId: opts.watsonxProjectId as string | undefined,
            gatewayPort:
